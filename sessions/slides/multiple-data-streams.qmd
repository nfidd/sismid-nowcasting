...
![A workflow for infectious disease modelling. Figure by Sam Abbott (MIT licence).](figures/workflow-diagram.png){height="460px"}
...
n <- 80
R <- c(rep(1.6, 30), rep(0.8, n - 30))
## larger I0 here is purely so the illustrative death counts are visible
infections <- renewal(200, R, gen_time_pmf)
...
obs <- tibble(
  ...
  deaths = rpois(n, 0.01 * convolve_with_delay(infections, death_delay)),
