...
The alternative, a *sequential* model, chains one stream off another (e.g. deaths off observed cases); apt only when one genuinely derives from another.
We use the parallel form throughout.
...
```{r conflict-fork, echo = FALSE, fig.width = 8.5, fig.height = 4}
