...
- several surveillance data sources are **delayed, scaled measurements** of the same infections
- a **shared latent infection process**, with a swappable observation model per data source
