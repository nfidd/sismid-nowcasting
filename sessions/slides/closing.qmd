...
- these ideas extend to **more complex reporting processes** (e.g. with [`epinowcast`](https://package.epinowcast.org/)) and to **jointly fitting multiple surveillance data streams** to estimate transmission from several sources at once
