...
A forecast is a **probabilistic statement about dates with *no data yet*** — an unconditional prediction of the future. The [forecasting course](https://nfidd.github.io/sismid-forecasting/) covers it in full; here is the motivation.
