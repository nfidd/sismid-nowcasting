...
The **expectation**, **reference** and **observation** modules mirror what we built by hand; the **report date** and **missing data** modules are new — they handle effects on the report date (e.g. day-of-week) and reports with an unknown reference date. Adding a feature is a one-line formula change.
