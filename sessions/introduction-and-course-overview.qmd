...
This is the **nowcasting** course, the first half of the SISMID week.
...
We'll combine this with the process of infectious disease transmission by thinking about the reproduction number.
With that, we can start to interpret the present (nowcasting) and predict the future (forecasting).
We then extend these ideas to more realistic settings, jointly fitting multiple data sources to estimate transmission from several sources at once, and modelling reporting processes that are more complex than a single fixed delay.
...
This nowcasting course is taught in-person over the first half of the SISMID week, but of course if you are studying this on your own using the web site you can go through the material at your own pace and in your own time.
