...
- A **proper scoring rule** scores a probabilistic forecast against the eventual observation; a forecaster minimises their expected score only by reporting what they genuinely believe, so honest forecasts are rewarded rather than ones tuned to game the metric.
...
- The CRPS breaks down into *overprediction* / *underprediction* (predicting too high or too low) and *dispersion* (a forecast that is too wide or too narrow).
