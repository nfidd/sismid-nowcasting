...
The key idea is that in real-time epidemic analysis nowcasting and forecasting are connected.
...
The key insight is that whether dealing with simple delays or more complex revisions, combining nowcasting and forecasting in a coherent framework improves predictions.
...
## Interactive: forecasting by projecting R(t)
...
Keep driving R(t) forward past the data to see how projecting the renewal process turns an estimation model into a forecast.
:::
