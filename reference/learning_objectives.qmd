...
- understanding of why combining multiple surveillance data sources can improve inference
- understanding of the difference between parallel (conditionally independent given infections) and sequential modelling of data sources
- familiarity with extending the renewal-with-delays model to several parallel data sources with their own delays, scalings and likelihoods
